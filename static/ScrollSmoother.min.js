        ...
        return (
          L ||
            ...
            F &&
              ...
              Y &&
                Q &&
                ((D = Q.core._getVelocityProp),
                (X = Q.core._inputObserver),
  ...
  function ScrollSmoother(t) {
      ...
      Ma(),
        ...
        S &&
          (S.forEach(function (e) {
            var t = e.start,
              r = e.auto
                ? Math.min(Q.maxScroll(e.scroller), e.end)
                : t + (e.end - t) / e.ratio,
              n = (r - e.end) / 2;
            (t -= n),
              (r -= n),
    ...
    function Ya(t, r, n, o) {
      return function () {
        ...
        return (
          e ||
            0 === e ||
            (e = o.getAttribute("data-" + _ + t) || ("speed" === t ? 1 : 0)),
          o.setAttribute("data-" + _ + t, e),
    ...
    function Za(r, e, t, n, o) {
      function Ob() {
        (e = f()),
          ...
          (c = (a = "auto" === e) ? 0 : 0.5),
          l && l.kill(),
          (l = t && F.to(r, { ease: q, overwrite: !1, y: "+=0", duration: t })),
        ...
        if (a) {
          ...
          var t = (function _autoDistance(e, t) {
            ...
            return (
              0 < c &&
                ((n =
                  0.5 == (r = s.height / (W.innerHeight + s.height))
                    ? 2 * s.height
                    : 2 *
                ...
                if (e.offset) {
                  if (i) {
                    ...
                    o =
                      ...
                      s +
                      m *
                        ((F.utils.clamp(e.start, e.end, r) - e.start - s) /
                          (n - e.start) -
                          c);
                  }
                  (o = (function _round(e) {
                    ...
                    l
                      ? (l.resetTo("y", o, -A, !0), M && l.progress(1))
    ...
    function refreshHeight() {
      return (
        ...
        (Y.style.height = W.innerHeight + (e - W.innerHeight) / O + "px"),
        e - W.innerHeight
      );
    }
    Va(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? u
            ? F.to(o, { duration: R, scrollTop: n, overwrite: "auto", ease: q })
            : C(n)
          : Qa(n);
      }),
        ...
        if (arguments.length) {
          ...
          return (
            t !== n &&
              ...
              R || F.set(n, { clearProps: "transform" })),
            this
          );
        }
        return n;
    ...
    B.forEach(function (e) {
      ...
      (i = Q.create({
        ...
        onRefresh: function onRefresh(e) {
          e.animation.invalidate(),
            e.setPositions(e.start, refreshHeight() / O),
            d || Oa(e),
            (U.y = -C()),
            Pa(U.y),
            M || e.animation.progress(F.utils.clamp(0, 1, f / -e.end)),
      ...
      (this.smooth = function (e) {
        return (
          arguments.length &&
            ((O = ((R = e || 0) && +t.speed) || 1), i.scrubDuration(e)),
          ...
          ? (!!u !== e &&
              (e
                ...
                : (u.nested.kill(),
                  ...
                  (u = 0),
                  r && r.enable(),
                  (i.progress = (-H - i.start) / (i.end - i.start)),
                  Oa(i))),
            this)
          : !!u;
      }),
      (this.kill = this.revert =
        function () {
          ...
          Q.scrollerProxy(v),
            ...
            (n.style.cssText = c);
          var r = Q.defaults({});
          r && r.scroller === v && Q.defaults({ scroller: W }),
            o.normalizer && Q.normalizeScroll(!1),
            clearInterval(a),
            (j = null),
            k && k.disconnect(),
            Y.style.removeProperty("height"),
            W.removeEventListener("focusin", Sa);
        }),
      (this.refresh = function (e, t) {
        return i.refresh(e, t);
      }),
      P &&
        (this.normalizer = Q.normalizeScroll(
          !0 === P ? { debounce: !0, content: !R && n } : P
        )),
      Q.config(t),
      "overscrollBehavior" in W.getComputedStyle(Y) &&
        F.set([Y, V], { overscrollBehavior: "none" }),
      "scrollBehavior" in W.getComputedStyle(Y) &&
        F.set([Y, V], { scrollBehavior: "auto" }),
